...
function showDetails(code, showCloudBox)
{
    ...
    if (showCloudBox) {
        var detailsElement = document.getElementById('status-report-detailsElement');
    ...
    if (hiddenElementDetails) {
        detailsElement.innerHTML = hiddenElementDetails.innerHTML;

    } else {
        detailsElement.innerHTML = '';
    }

    if (hiddenElementHeader) {
        headerElement.innerHTML = hiddenElementHeader.innerHTML;
    ...
    if (showCloudBox) {
        document.getElementById('suppose-cloud').style.display = '';

    } else {
        document.getElementById('suppose-cloud').style.display = 'none';
    }
