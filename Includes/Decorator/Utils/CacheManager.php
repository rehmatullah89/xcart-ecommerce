...
abstract class CacheManager extends \Includes\Decorator\Utils\AUtils
{
    ...
    {
        $src = \Includes\Utils\URLManager::getShopURL('skins/progress_indicator.gif', null, array(), null, false);
        $message = static::getMessage();

        return static::getJSMessage() . '<table><tr><td><img src="' . $src . '" alt="" /></td><td>' . $message . '</td></tr></table>';
    }
