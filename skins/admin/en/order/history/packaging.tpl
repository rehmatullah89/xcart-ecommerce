...
<div class="order-packaging">
  ...
  <ul class="packages">
    <li FOREACH="getPackages(),id,package">
      <div><span class="package-id">{t(#Package#)} #{id}</span> <span class="package-props">[{t(#weight#)}: {package.weight} {config.Units.weight_symbol}, {t(#dimensions#)}: {package.box.length}x{package.box.width}x{package.box.height} {config.Units.dim_symbol}]</span></div>
