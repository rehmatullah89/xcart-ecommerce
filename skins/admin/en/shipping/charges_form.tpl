...
var lbl_no_items_have_been_selected = '{t(#There are no markups selected#)}';
...
<tr>
  <td><div style="line-height:170%"><b><a href="javascript:change_all(true);">{t(#Check all#)}</a> / <a href="javascript:change_all(false);">{t(#Uncheck all#)}</a></b></div></td>
  <td align="right"><a href="#addmarkup"}><b>{t(#Add markup#)}</b></a></td>
</tr>
</table>
...
<form action="admin.php" method="post" name="shippingratesform">
  ...
  {foreach:getPreparedShippingMarkups(),zid,zn}
          ...
          <table cellpadding="0" cellspacing="3" width="100%">
            <tbody FOREACH="method.markups,mid,markup">
              <tr>
                ...
                <td>{t(#Weight range#)} ({config.Units.weight_symbol}):</td>
              ...
              <tr>
                <td>{t(#Subtotal range#)} ({xlite.currency.getSymbol()}):</td>
                <td class="table-label">
    ...
    <tr>
      <td>
        <widget class="\XLite\View\Button\Regular" label="{t(#Delete selected#)}" jsCode="if (checkMarks(this.form, new RegExp('to_delete\\[[0-9]+\\]', 'gi'))) submitForm('shippingratesform', 'delete');" />
        &nbsp;&nbsp;&nbsp;&nbsp;
...
<form name="addshippingrate" action="admin.php" method="post" IF="getShippingMethods()">
  ...
  <a name="addmarkup"></a>
  <div class="admin-title">{t(#Add markup#)}</div>
  <br /><br />
  <table class="data-table">

    <tr>
      <td>{t(#Shipping method#)}:</td>
      <td>&nbsp;</td>
      <td>
        <select name="new[method_id]">
          <option value="">{t(#Please select one#)}</option>
          <option FOREACH="getShippingMethods(),m" value="{m.getMethodId()}" selected="{isSelected(m,#method_id#,methodid)}">{m.getName()}</option>
        </select>
      </td>
    </tr>

    <tr>
      <td>{t(#Destination zone#)}:</td>
      <td>&nbsp;</td>
      <td>
        <select name="new[zone_id]">
          <option FOREACH="getShippingZones(),zn" value="{zn.getZoneId()}" selected="{isSelected(zn,#zone_id#,zoneid)}">{zn.getZoneName()}</option>
        </select>
      </td>
    </tr>
  ...
  <table class="data-table">
    ...
    <tr>
      <td>{t(#Weight range#)} ({config.Units.weight_symbol}):</td>
      <td class="table-label">
        <input type="text" name="new[min_weight]" size="9" value="0.00" />
        -
        <input type="text" name="new[max_weight]" size="9" value="999999.00" />
      </td>
      <td>{t(#Flat markup#)} ({xlite.currency.getSymbol()}):</td>
      <td class="table-label"><input type="text" name="new[markup_flat]" size="5" value="0.00" /></td>
      <td>{t(#Percent markup#)} (%):</td>
      <td><input type="text" name="new[markup_percent]" size="5" value="0.00" /></td>
    </tr>

    <tr>
      <td>{t(#Subtotal range#)} ({xlite.currency.getSymbol()}):</td>
      <td class="table-label">
        <input type="text" name="new[min_total]" size="9" value="0.00" />
        -
        <input type="text" name="new[max_total]" size="9" value="999999.00" />
      </td>
      <td>{t(#Markup per item#)} ({xlite.currency.getSymbol()}):</td>
      <td class="table-label"><input type="text" name="new[markup_per_item]" size="5" value="0.00" /></td>
      <td>{t(#Markup per weight unit#)} ({xlite.currency.getSymbol()}):</td>
      <td class="table-label"><input type="text" name="new[markup_per_weight]" size="5" value="0.00" /></td>
    </tr>
    ...
    <tr>
      ...
      <td class="table-label">
        ...
        -
        <input type="text" name="new[max_items]" size="9" value="999999" />
      </td>
      <td colspan="4">&nbsp;</td>
    </tr>
