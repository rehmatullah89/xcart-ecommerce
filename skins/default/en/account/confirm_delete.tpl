...
<form action="{buildURL()}" method="post" name="delete_account_form">
  ...
  <div class="delete-user-buttons-list">
    <widget class="\XLite\View\Button\Submit" label="Proceed" style="action button-proceed" />

    <widget class="\XLite\View\Button\Regular" label="Cancel" jsCode="void(0);" style="action button-cancel" />
  </div>
