...
abstract class ACustomer extends \XLite\Controller\AController
{
    ...
    {
        return \XLite\Model\Cart::getInstance($this->markCartCalculate());
    }
    ...
    public function getCanonicalURL()
    {
        ...
        return $this->getShopURL(\XLite\Core\Converter::buildURL($target, '', $params, null, true), $this->isHTTPS());
    }
    ...
    protected function needSecure()
    {
        return parent::needSecure()
            ...
            && \XLite\Core\Config::getInstance()->Security->full_customer_security;
    }
