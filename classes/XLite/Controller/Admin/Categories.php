...
class Categories extends \XLite\Controller\Admin\AAdmin
{
    ...
    {
        $list = new \XLite\View\ItemsList\Model\Category;
        $list->processQuick();
    }
    ...
    {
        $cellName = \XLite\View\ItemsList\Model\Category::getSessionCellName();
    ...
    protected function getSearchParams()
    {
        ...
        foreach (
            \XLite\View\ItemsList\Model\Category::getSearchParams() as $requestParam
        ) {
