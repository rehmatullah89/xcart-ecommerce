...
class Import extends \XLite\Controller\Admin\AAdmin
{
    ...
    public function getImporter()
    {
        if (!isset($this->importer)) {
            $state = \XLite\Core\Database::getRepo('XLite\Model\TmpVar')->getEventState('import');
    ...
    {
        foreach (array('clearItems', 'clearImportDir') as $key) {
        ...
        $dirTo = LC_DIR_VAR . \XLite\Logic\Import\Importer::IMPORT_DIR;
    ...
    {
        $event = \XLite\Core\Database::getRepo('XLite\Model\TmpVar')->getEventState('import');
