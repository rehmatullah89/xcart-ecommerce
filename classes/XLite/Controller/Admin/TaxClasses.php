 ...
 */
class TaxClasses extends \XLite\Controller\Admin\AAdmin
{
    ...
    {
        $cellName = \XLite\View\ItemsList\Model\TaxClass::getSessionCellName();
    ...
    protected function getSearchParams()
    {
        ...
        foreach (
            \XLite\View\ItemsList\Model\TaxClass::getSearchParams() as $requestParam
        ) {
