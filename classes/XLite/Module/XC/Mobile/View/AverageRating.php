...
class AverageRating extends \XLite\Module\XC\Reviews\View\AverageRating implements \XLite\Base\IDecorator
{
    ...
    {
       return \XLite\Core\Request::isMobileDevice() ? false : parent::isVisibleAverageRating();
    }
    ...
    {
       return \XLite\Core\Request::isMobileDevice() ? false : parent::isVisibleAverageRatingOnPage();
    }
}
