...
class Category extends \XLite\View\Category implements \XLite\Base\IDecorator
{
    ...
    protected function getDescription()
    {
        return \XLite\Core\Request::isMobileDevice()
            ? ((\XLite::getController()->getCategoryId() == $this->getRootCategoryId())
                ? \XLite\Core\Config::getInstance()->XC->Mobile->mobile_homepage_text
                : $this->getCategory()->getViewDescription()
            )
