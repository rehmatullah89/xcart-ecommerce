...
class ProductVariant extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        ...
        return $columns + array(
            'price' => array(
                ...
                static::COLUMN_PARAMS    => array(
                    'attributes' => array(
                        'placeholder' => static::t('Default price'),
                    )
                ),
            ...
            'sku' => array(
                ...
                static::COLUMN_PARAMS    => array(
                    'attributes' => array(
                        'placeholder' => static::t('Default SKU'),
                    )
                ),
            ...
            'amount' => array(
                ...
                static::COLUMN_PARAMS    => array(
                    'attributes' => array(
                        'placeholder' => static::t('Default QTY'),
                    )
                ),
    ...
    {
        return $this->isAllowVaraintAdd() ? static::CREATE_INLINE_BOTTOM : null;
    }
