...
abstract class Products extends \XLite\Logic\Import\Processor\Products implements \XLite\Base\IDecorator
{
     ...
     * @return void
     */
    protected function importVariantSKUColumn(\XLite\Model\Product $model, array $value, array $column)
    {
     ...
     * @return void
     */
    protected function importVariantPriceColumn(\XLite\Model\Product $model, array $value, array $column)
    {
        foreach ($this->variants as $rowIndex => $variant) {
     ...
     * @return void
     */
    protected function importVariantQuantityColumn(\XLite\Model\Product $model, array $value, array $column)
    {
        foreach ($this->variants as $rowIndex => $variant) {
