...
class Marketplace extends \XLite\Base\Singleton
{
    ...
    {
        return 'http://www.x-cart.com/software_pricing.html?utm_source=xc5&utm_medium=evaluation-notice&utm_campaign=XC5+evaluation+notice';
    }
    ...
    {
        $result = $this->performActionWithTTL($ttl, static::ACTION_GET_ALL_TAGS);
    ...
    protected function sendRequestToMarketplace($action, array $data = array())
    {
        ...
        $skipRequest = \XLite\Core\Session::getInstance()->mpServerError
