...
class Main extends \XLite\View\SearchPanel\Order\Admin\AAdmin
{
    ...
    protected function defineConditions()
    {
        return parent::defineConditions() + array(
            ...
            'status' => array(
                static::CONDITION_CLASS => '\XLite\View\FormField\Select\OrderStatus',
                \XLite\View\FormField\AFormField::PARAM_FIELD_ONLY          => true,
                \XLite\View\FormField\Select\OrderStatus::PARAM_ALL_OPTION  => true,
                \XLite\View\FormField\Select\OrderStatus::PARAM_DISPLAY_ALL => true,
            ),
            'dateRange' => array(
