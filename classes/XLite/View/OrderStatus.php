...
class OrderStatus extends \XLite\View\AView
{
    ...
    protected $cssClasses = array(
        ...
        \XLite\Model\Order::STATUS_CANCELED         => 'order-status-canceled',
        \XLite\Model\Order::STATUS_FAILED           => 'order-status-failed',
        \XLite\Model\Order::STATUS_DECLINED         => 'order-status-declined',
        \XLite\Model\Order::STATUS_EXPIRED          => 'order-status-expired',
        \XLite\Model\Order::STATUS_REFUND_REQUESTED => 'order-status-refund-requested',
        \XLite\Model\Order::STATUS_REFUNDED         => 'order-status-refunded',
        \XLite\Model\Order::STATUS_PART_REFUNDED    => 'order-status-part-refunded',
        \XLite\Model\Order::STATUS_SHIPPED          => 'order-status-shipped',
    );
    ...
    protected $titles = array(
        ...
        \XLite\Model\Order::STATUS_SHIPPED          => 'Shipped',
        \XLite\Model\Order::STATUS_COMPLETED        => 'Completed',
        \XLite\Model\Order::STATUS_CANCELED         => 'Canceled',
        \XLite\Model\Order::STATUS_FAILED           => 'Failed',
        \XLite\Model\Order::STATUS_DECLINED         => 'Declined',
        \XLite\Model\Order::STATUS_EXPIRED          => 'Expired',
        \XLite\Model\Order::STATUS_REFUND_REQUESTED => 'Refund requested',
        \XLite\Model\Order::STATUS_REFUNDED         => 'Refunded',
        \XLite\Model\Order::STATUS_PART_REFUNDED    => 'Partially refunded',
    );
