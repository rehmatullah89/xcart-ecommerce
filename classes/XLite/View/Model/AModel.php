...
abstract class AModel extends \XLite\View\Dialog
{
    ...
    const SCHEMA_PLACEHOLDER    = \XLite\View\FormField\Input\Base\String::PARAM_PLACEHOLDER;
    ...
    protected function getModelObjectValue($name)
    {
        ...
        if (is_object($model)) {
            ...
            // $method - assmble fron 'get' + property name
            $result = method_exists($model, $method) ? $model->$method() : $model->getterProperty($name);
        }
