...
class Category extends \XLite\View\Model\AModel
{
    ...
    protected $schemaDefault = array(
        ...
        'image' => array(
            ...
            self::SCHEMA_REQUIRED => false,
            \XLite\View\FormField\Image::PARAM_OBJECT => 'category',
        ),
        'description' => array(
    ...
    {
        if ($this->getModelObject()->getCategoryId()) {
            $this->schemaDefault['image'][\XLite\View\FormField\Image::PARAM_OBJECT_ID] = $this->getDefaultModelObject()->getCategoryId();
