...
class ModuleSettings extends \XLite\View\Model\Settings
{
    ...
    protected function getFormButtons()
    {
        ...
        $result['addons-list'] = new \XLite\View\Button\Link(
            array(
                \XLite\View\Button\AButton::PARAM_LABEL => 'Back to modules',
                \XLite\View\Button\AButton::PARAM_STYLE => 'action addons-list-back-button',
                \XLite\View\Button\Link::PARAM_LOCATION => $this->buildURL('addons_list_installed'),
            )
        );
